...
\begin{figure*}
  \centering
  \subfloat{\includegraphics[width=0.22\textwidth]{../daisiesFromBing512x512}}~
  \subfloat{\includegraphics[width=0.22\textwidth]{../hardedges_512x512}}~
  \subfloat{\includegraphics[width=0.22\textwidth]{../penguinsFromBing512x512}}~
  \subfloat{\includegraphics[width=0.22\textwidth]{../velos512x512}}~
  \caption{The four additional images used during the optimisation.}
  \label{new_images}
\end{figure*}
...
\begin{figure}
  ...
  \caption{Two parameters that seem to converge quite well during the optimisation.}
...
\item Matching pursuit~\cite{matchingpursuit93} with an overcomplete dictionary of discrete cosines. TODO this reference is wrong!
\end{enumerate}
