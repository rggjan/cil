...
\begin{document}
\title{Image restoration using dimension reduction in the Fourier domain}
...
These distortions may, for example, result from a transmission over a noisy channel.
We distinguish inpainting from image 
((( TODO )))
